...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "bibhutinayak309@gmail.com";
        ...
        <div
          className={cn(
            ...
            `group-hover/bento:translate-x-2 transition duration-200 relative md:h-full ${
              id === 3 ? "min-h-60" : "min-h-40"
            } flex flex-col px-5 p-5 lg:p-10`
          )}
        >
          <div className="font-sans font-semibold text-lg lg:text-2xl w-fit z-20 ">
            {title}
          </div>
          <div className="font-sans font-bold max-w-[550px] md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
